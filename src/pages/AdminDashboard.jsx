...
const filteredUsers = dbUsers
  ...
  return (
    <div style={{ paddingTop:'88px', minHeight:'100vh', position:'relative' }}>
      ...
      <div style={{ background:'rgba(17,34,64,0.5)', borderBottom:'1px solid var(--border)', padding:'24px 0' }}>
        <div className="container" style={{ display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:'12px' }}>
          <div>
            <p style={{ color:'#f4a825', fontSize:'0.78rem', letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:'4px' }}>Admin Panel</p>
            <h1 style={{ fontFamily:'Syne, sans-serif', fontSize:'1.7rem' }}>CareerForge Administration</h1>
            <p style={{ color:'var(--muted)', fontSize:'0.82rem' }}>Logged in as: <span style={{ color:'var(--purple-light)' }}>{adminEmail}</span></p>
          </div>
          <div style={{ color:'#64ffda', fontSize:'0.83rem' }}>● All systems operational</div>
        </div>
      </div>
