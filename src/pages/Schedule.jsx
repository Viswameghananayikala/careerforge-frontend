...
setGroupedSlots(grouped)
  ...
  return (
    <div style={{ paddingTop: '88px', minHeight: '100vh', position: 'relative' }}>
      ...
      {/* Page header */}
      <div style={{ background: 'rgba(8,15,31,0.7)', borderBottom: '1px solid var(--border)', padding: '28px 0' }}>
...
const s = {
  ...
  summary: { background: 'rgba(8,15,31,0.7)', border: '1px solid var(--border)', borderRadius: '10px', padding: '14px' },
  ...
  confirmCard: { background: 'rgba(8,15,31,0.7)', borderRadius: '10px', padding: '14px', marginBottom: '22px', textAlign: 'left' },
