...
const s = {
  bell: { position: 'relative', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', padding: '8px 10px', cursor: 'pointer', fontSize: '1rem' },
  ...
  dropdown: { position: 'absolute', right: 0, top: '44px', width: '300px', background: '#0d1e35', border: '1px solid rgba(29,78,216,0.3)', borderRadius: '14px', boxShadow: '0 16px 40px rgba(0,0,0,0.4)', zIndex: 3000, maxHeight: '360px', overflowY: 'auto' },
